...
class ApiClient:
    ...
    async def compare_local_server(self):
        ...
        # Print name and location from both sides
        print(f"Local name: {self.node_config['name']}")
        print(f"Server name: {response['name']}")
        print(f"Local location: {self.node_config['location']}")
        print(f"Server location: {response['location']}")
